	...
	<div>
		<div class="container">
			...
			<div class="container-home">
				...
				<ul class="navbar">
					<li class="c"><router-link to="/home"><h4 style="color: black;">推荐</h4></router-link></li>
					<li class="c"><router-link to="/home/follow"><h4>关注</h4></router-link></li>
					<li class="c"><router-link to="/home/hot"><h4>热榜</h4></router-link></li>
			</ul>
			<router-view />
			</div>
			...
			<div class="container-right">
				<div class="card">
					...
					<div class="row">
					<div class="w-col-4 lan">
						<svg class="dark-grey" fill="currentColor" viewBox="0 0 24 24" width="20" height="20" color="rgb(133,144,166)"><path d="M15.375 14.74V6.75c0-1.036-.84-1.875-1.875-1.875h-9c-1.036 0-1.875.84-1.875 1.875v10.5c0 1.036.84 1.875 1.875 1.875h9c1.036 0 1.875-.84 1.875-1.875v-2.51zm2.25-7.428l1.657-1.435a2.625 2.625 0 0 1 4.343 1.985v8.276a2.625 2.625 0 0 1-4.343 1.985l-1.657-1.435v.562a4.125 4.125 0 0 1-4.125 4.125h-9A4.125 4.125 0 0 1 .375 17.25V6.75A4.125 4.125 0 0 1 4.5 2.625h9a4.125 4.125 0 0 1 4.125 4.125v.562zm0 2.976v3.424l3.13 2.71a.375.375 0 0 0 .62-.284V7.862a.375.375 0 0 0-.62-.284l-3.13 2.71z"></path></svg>
						<h4>发视频</h4>
					</div>
					<div class="w-col-4 lan">
						<svg class="dark-grey" fill="currentColor" viewBox="0 0 24 24" width="24" height="20" color="rgb(133,144,166)"><path d="M12.004 4.15a7.85 7.85 0 1 1-5.772 13.17.85.85 0 0 1 1.25-1.153 6.15 6.15 0 1 0-1.559-5.087l1.208.343a.542.542 0 0 1 .112.996l-2.597 1.42a.542.542 0 0 1-.732-.21l-1.44-2.561a.542.542 0 0 1 .62-.787l1.182.334a7.852 7.852 0 0 1 7.728-6.465zm-.178 3.792c.385 0 .7.31.7.69l-.003 3.495 2.564 1.693c.315.207.425.671.185.977-.24.305-.69.33-.99.126 0 0-2.53-1.663-2.844-1.9-.315-.236-.315-.551-.315-.551l.003-3.84c0-.38.315-.69.7-.69z" fill-rule="evenodd"></path></svg>
						<h4>稍后答</h4>
					</div>
					<div class="w-col-4 lan">
						<svg class="dark-grey" fill="currentColor" viewBox="0 0 24 24" width="24" height="20" color="rgb(133,144,166)"><path d="M12.917 4a2 2 0 0 1 1.478.652l4.083 4.475A2 2 0 0 1 19 10.475v5.345c0 1.453-.155 1.98-.445 2.512-.29.531-.717.948-1.26 1.232-.543.285-1.082.436-2.568.436H9.273c-1.486 0-2.025-.151-2.568-.436a2.997 2.997 0 0 1-1.26-1.232C5.155 17.8 5 17.273 5 15.82V8.18c0-1.453.155-1.98.445-2.512.29-.531.717-.948 1.26-1.232C7.248 4.15 7.787 4 9.273 4h3.644zM12 5.63H9.273c-1.103 0-1.439.064-1.782.243a1.348 1.348 0 0 0-.576.564c-.183.336-.248.664-.248 1.743v7.64c0 1.079.065 1.407.248 1.743.135.247.323.431.576.564.343.18.68.243 1.782.243h5.454c1.103 0 1.439-.064 1.782-.243.253-.133.44-.317.576-.564.183-.336.248-.664.248-1.743V11.3H14a2 2 0 0 1-2-2V5.63zm1.5.37v2.9a.9.9 0 0 0 .9.9H17L13.5 6z"></path></svg>
					<h4>草稿箱</h4>
					</div>
					</div>
				</div>
				...
				<div class="card">
					<div class="row">
						<svg class="dark-grey margin-left-5" fill="currentColor" viewBox="0 0 24 24" width="24" height="24"><path d="M15.075 15.388l-3.024 3.024a4.041 4.041 0 0 0-1.014 1.697l-.26.868C7.844 20.986 4.91 21 2 21c.026-3.325 0-3.304.59-3.956 1.237-1.368 6.251-.68 6.44-2.976.043-.518-.36-1.06-.725-1.69C6.285 8.87 5.512 2 11.5 2c5.988 0 5.15 7.072 3.246 10.378-.357.62-.795 1.217-.724 1.77.073.571.477.958 1.053 1.24zm5.402 1.672c.523.55.523.646.523 3.94a535.11 535.11 0 0 0-4.434-.028l3.911-3.912zm-7.88 2.699c.111-.37.312-.705.584-.978l4.76-4.76a.291.291 0 0 1 .412 0l1.626 1.626a.291.291 0 0 1 0 .411l-4.76 4.76c-.272.273-.608.474-.978.585l-1.96.588a.219.219 0 0 1-.272-.272l.589-1.96zm9.157-6.742a.839.839 0 0 1 0 1.187l-.94.94a.28.28 0 0 1-.395 0l-1.563-1.563a.28.28 0 0 1 0-.395l.94-.94a.839.839 0 0 1 1.187 0l.771.771z" fill-rule="evenodd"></path></svg>
					<p class="dark-grey margin-left-5">创作者中心</p>
					<P class="zhihu-blue margin-left-5">Lv1</P>
					<p class="arrows dark-grey">></p>
					</div>
					<div class="line"></div>
					<div class="row">
						<div class="one t-center">
							<h5 class="dark-grey" >昨日被阅读数</h5>
							<h3>0</h3>
								<h5 class="dark-grey">较前日--</h5>
						</div>
						<div class="two t-center">
							<h5 class="dark-grey" >昨日获赞同数</h5>
							<h3>0</h3>
								<h5 class="dark-grey">较前日--</h5>
						</div>
					</div>
					<div class="line"></div>
					<div class="row dark-grey margin-10 margin-left-5">
						<h5>瓦力保镖为你创作提供持续保护</h5>
						<svg width="17" height="17" viewBox="0 0 16 16" class="css-14gt3bc" fill="currentColor"><path d="M8 3l.737.339.428.187.377.158.326.127c.15.055.282.1.395.133.55.161 1.297.157 2.237-.014l-.002 3.784c0 3.07-2.52 4.76-4.498 5.286-1.977-.527-4.498-2.216-4.498-5.286L3.5 3.93c.94.17 1.686.175 2.237.014C6.187 3.812 6.941 3.497 8 3zm2.38 3.066L7.599 8.834 6.32 7.566a.4.4 0 0 0-.554.554l1.55 1.55a.5.5 0 0 0 .568 0l3.05-3.05a.4.4 0 0 0-.554-.554z"></path></svg>
					</div>
				</div>
					...
					<div class="card">
						<div class="row">
						<div class="w-col-4 Zi--Live">
							<svg class="Live" fill="currentColor" viewBox="0 0 24 24" width="24" height="24"><path d="M13.693 10.354l1.634-7.542c.195-.901-.16-1.083-.798-.39l-9.18 9.97c-.638.693-.377 1.254.582 1.254h5.376l-1.634 7.542c-.195.901.16 1.083.798.39l9.18-9.97c.638-.693.377-1.254-.582-1.254h-5.376z"></path></svg>
							<h4>Live</h4>
						</div>
						<div class="w-col-4 Zi--Ebook">
<svg class="Ebook" fill="currentColor" viewBox="0 0 24 24" width="24" height="24"><path d="M16 17.649V2.931a.921.921 0 0 0-.045-.283.943.943 0 0 0-1.182-.604L4.655 5.235A.932.932 0 0 0 4 6.122v14.947c0 .514.421.931.941.931H19.06c.52 0 .941-.417.941-.93V7.292a.936.936 0 0 0-.941-.931h-.773v12.834a.934.934 0 0 1-.83.924L6.464 21.416c-.02.002 2.94-.958 8.883-2.881a.932.932 0 0 0 .653-.886z" fill-rule="evenodd"></path></svg>
							<h4>书店</h4>
						</div>
						<div class="w-col-4 Zi--Org">
<svg class="Org" fill="currentColor" viewBox="0 0 24 24" width="24" height="24"><path d="M10.786 8.41a8.938 8.938 0 0 0-3.968-2.528c-.305-1.719.814-3.337 2.442-3.741 1.221-.405 2.646.101 3.46 1.011 1.045 1.38.915 3.64.814 4.348-.102 1.315-1.221 3.034-1.323 3.135-.305-.809-.814-1.517-1.425-2.225zm-2.442 2.832c-1.526.202-3.052 1.01-4.171 2.123-1.12-.404-1.934-1.314-2.137-2.427-.316-2.427 1.526-3.64 2.849-3.842 1.628-.371 2.849.505 4.07 1.415 1.146 1.012 2.035 2.63 2.035 2.73-.916-.202-1.832-.1-2.646 0zm4.986.303c.509-.607.931-1.586 1.12-2.225.318-1.039.61-3.134.203-4.651 1.323-1.011 3.154-1.011 4.477.303 1.235 1.146 1.017 2.933.814 3.438-.663 1.581-1.933 2.326-3.256 2.832-1.221.404-3.256.303-3.358.303zm-2.645 1.011c-.51.607-.916 1.416-1.221 2.326-.407 1.314-.643 3.06-.102 4.55-1.323 1.011-3.256 1.011-4.477-.202-1.198-1.124-1.018-2.932-.814-3.438.599-1.605 1.933-2.326 3.256-2.831.916-.304 3.256-.405 3.358-.405zm9.259-1.82c1.017.404 1.933 1.315 2.035 2.427.233 2.57-1.526 3.64-2.849 3.842-1.526 0-2.85-.505-4.07-1.415-1.018-.81-2.035-2.528-2.035-2.63.916.203 1.831.102 2.645 0 1.628-.404 3.053-1.112 4.274-2.224zm-6.716 4.854c1.065 1.08 2.442 2.022 4.07 2.528.306 1.719-.814 3.235-2.442 3.741-1.22.405-2.645-.101-3.46-1.011-1.1-1.481-1.017-3.54-.915-4.247.102-1.315 1.221-3.034 1.323-3.135.305.708.721 1.44 1.424 2.124z"></path></svg>
							<h4>圆桌</h4>
						</div>
						</div>
						
						<div class="row">
						<div class="w-col-4 Zi--Edit">
							<svg class="Edit" fill="currentColor" viewBox="0 0 24 24" width="24" height="24"><path d="M4.076 16.966a4.19 4.19 0 0 1 1.05-1.76l8.568-8.569a.524.524 0 0 1 .741 0l2.928 2.927a.524.524 0 0 1 0 .74l-8.568 8.57c-.49.49-1.096.852-1.761 1.051l-3.528 1.058a.394.394 0 0 1-.49-.488l1.06-3.53zM20.558 4.83c.59.59.59 1.546 0 2.136l-1.693 1.692a.503.503 0 0 1-.712 0l-2.812-2.812a.504.504 0 0 1 0-.712l1.693-1.693a1.51 1.51 0 0 1 2.135 0l1.389 1.389z"></path></svg>
							<h4>专栏</h4>
						</div>
						<div class="w-col-4 Zi--Infinity">
<svg class="Infinity" fill="currentColor" viewBox="0 0 24 24" width="24" height="24"><path d="M11.267 10.188h-2.69a.26.26 0 0 0-.261.26v.508c0 .149.117.26.262.26h2.896v1.54H8.578a.26.26 0 0 0-.262.259v.508c0 .15.117.26.262.26h2.896v2.31c0 .139.119.257.265.257h.522a.258.258 0 0 0 .265-.257v-2.31h2.896a.26.26 0 0 0 .262-.26v-.508a.257.257 0 0 0-.262-.26h-2.896v-1.54h2.896a.26.26 0 0 0 .262-.26v-.507a.257.257 0 0 0-.262-.26h-2.69l2.51-2.636a.26.26 0 0 0-.004-.366l-.423-.413a.253.253 0 0 0-.36.01L12 9.418 9.545 6.784a.248.248 0 0 0-.36-.011l-.423.413a.264.264 0 0 0-.004.366l2.509 2.636zM12 19.973c-1.101 0-2.16-.15-3.152-.43-.532.18-5.27 2.177-4.743 1.179.527-.998 1.58-2.746.806-3.25C3.11 15.936 2 13.822 2 11.486 2 6.8 6.477 3 12 3s10 3.8 10 8.487-4.477 8.486-10 8.486z"></path></svg>
							<h4>付费咨询</h4>
						</div>
						<div class="w-col-4 Zi--KnowledgeBase">
<svg class="KnowledgeBase" fill="currentColor" viewBox="0 0 24 24" width="24" height="24"><path d="M21 9.749v9.91c0 .74-.604 1.341-1.35 1.341H4.35C3.604 21 3 20.4 3 19.659V9.319c0-.503.283-.963.733-1.193l4.892-2.5V3.341c0-.74.604-1.341 1.35-1.341.267 0 .527.078.749.225l9.675 6.408c.375.249.601.668.601 1.116zM8.297 8.307L5.372 9.802A.223.223 0 0 0 5.25 10v8.54c0 .124.1.224.225.224h8.586a.223.223 0 1 0 .124-.41l-4.959-3.259a1.339 1.339 0 0 1-.601-1.116V8.506a.224.224 0 0 0-.328-.199z"></path></svg>
						<h4>百科</h4>
						</div>
						</div>
					</div>
					...
					<div class="card-2">
						<div class="row w-fx-between lump">
							<div class="w-fx-left dark-grey">
								<svg class="margin-right-5" fill="currentColor" viewBox="0 0 24 24" width="18" height="18"><path d="M5.515 19.64l.918-5.355-3.89-3.792c-.926-.902-.639-1.784.64-1.97L8.56 7.74l2.404-4.871c.572-1.16 1.5-1.16 2.072 0L15.44 7.74l5.377.782c1.28.186 1.566 1.068.64 1.97l-3.89 3.793.918 5.354c.219 1.274-.532 1.82-1.676 1.218L12 18.33l-4.808 2.528c-1.145.602-1.896.056-1.677-1.218z" fill-rule="evenodd"></path></svg>
								<P>我的收藏</P>
							</div>
							<div class="w-fx-right dark-grey">
								<p class="frame">0</p>
							</div>
						</div>
						<div class="row w-fx-between lump">
					...
					<div class="row dark-grey card-end">
						<a class="dark-grey">刘看山</a>
						<span class="Footer-dot">·</span>
						<a class="dark-grey">知乎指南</a>
						<span class="Footer-dot">·</span>
						<a class="dark-grey">知乎协议</a>
						<span class="Footer-dot">·</span>
						<a class="dark-grey">知乎隐私保护指引</a>
					</div>
					<div class="row dark-grey card-end">
						<a class="dark-grey">应用</a>
						<span class="Footer-dot">·</span>
						<a class="dark-grey">工作</a>
						<span class="Footer-dot">·</span>
						<a class="dark-grey">申请开通知乎机构号</a>
					</div>
					<div class="row dark-grey card-end">
						<a class="dark-grey">侵权举报</a>
						<span class="Footer-dot">·</span>
						<a class="dark-grey">网上有害消息举报专区</a>
					</div>
					<div class="row dark-grey card-end">
						<a class="dark-grey">京ICP证110745号</a>
					</div>
					<div class="row dark-grey card-end">
						<a class="dark-grey">京ICP证13052560号-1</a>
					</div>
					<div class="row dark-grey card-end">
						<img src="https://pic3.zhimg.com/80/v2-d0289dc0a46fc5b15b3363ffa78cf6c7.png">
						<a class="dark-grey">京公网安备11010802010035号</a>
					</div>
					<div class="row dark-grey card-end">
						<a class="dark-grey">互联网药品信息服务资格证书</a>
					</div>
					<div class="row dark-grey card-end">
						<a class="dark-grey">（京）-非经营性-2017-0067</a>
					</div>
					<div class="row dark-grey card-end">
						<a class="dark-grey">违法和不良信息举报：010-82716601</a>
					</div>
					<div class="row dark-grey card-end">
						<a class="dark-grey">儿童色情信息举报专区</a>
					</div>
					<div class="row dark-grey card-end">
						<a class="dark-grey">证照中心</a>
					</div>
					<div class="row dark-grey card-end">
						<a class="dark-grey">联系我们©2020知乎</a>
					</div>
				</div>
			</div>
...
<style lang="scss" scoped>
	...
	.Zi--Live,.Zi--Ebook,.Zi--Org,.Zi--Edit,.Zi--Infinity,.Zi--KnowledgeBase{
		color: rgb(133,144,166);
	}
	.Live,.Zi--Live:hover{
		color: rgb(255,207,0);
	}
	.Ebook,.Zi--Ebook:hover{
	...
	.Infinity,.Zi--Infinity:hover{
		color: rgb(84,120,240);
	}
	.KnowledgeBase,.Zi--KnowledgeBase:hover{
